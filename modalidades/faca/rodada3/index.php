    ...
    for ($cont=1; $cont<8; $cont++)
    {
        echo "       
            ...
            <table border='1' class='rodada'>
                ...
                <tr>
                    <th>". $jogador[$ajud]; echo "<a href='https://api.whatsapp.com/send?phone=". $contatojogador[$ajud]; echo "'><i style='margin:5px;' class='fa-brands fa-whatsapp'></i></a></th><td>". $rodada1[$ajud]; echo" </td><th>X</th><td>". $rodada1[$ajud+1]; echo "</td><th>"; echo "<a href='https://api.whatsapp.com/send?phone=". $contatojogador[$ajud+1]; echo "'><i style='margin:5px;' class='fa-brands fa-whatsapp'></i></a>". $jogador[$ajud+1]; echo"</th>
                </tr>
                <tr>
