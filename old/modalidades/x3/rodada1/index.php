...
<?php
    ...
    echo "<div class='seta'><a href='../'><img src='../../../icons/seta-esquerda.ico'></a><a href='../rodada2/'><img src='../../../icons/seta-direita.ico'></a></div>";
    $ajud = 0;
    ...
    for ($cont=1; $cont<5; $cont++)
    {
        echo "       
            ...
            <table border='1' class='rodada'>
                ...
                <tr>
                    <th>". $equipe[$ajud]; echo "<a href='https://api.whatsapp.com/send?phone=". $contato[$ajud]; echo "'><i style='margin:5px;' class='fa-brands fa-whatsapp'></i></a></th><td>". $rodada1[$ajud]; echo" </td><th>X</th><td>". $rodada1[$ajud+3]; echo "</td><th>"; echo "<a href='https://api.whatsapp.com/send?phone=". $contato[$ajud+3]; echo "'><i style='margin:5px;' class='fa-brands fa-whatsapp'></i></a>". $equipe[$ajud+3]; echo"</th>
                </tr>
                <tr>
