...
<body>
    ...
    <div class="card">
        <div class="nome-equipe"><h1>LOS GEDES</h1><h4>THREAT SIGNAL</h4></div>
        <div class="nome-capitao"><h3><a href="https://api.whatsapp.com/send?phone=5491158839350">Agus el father<span class="icon-whats"><i class="fa-brands fa-whatsapp"></i></span></h3></a></div>
        <div class="horario">
            <div class="hor-atual">      
                <p id="agus" onload="horaAgus();"></p>
            </div>
            <img src="icons/argentina.ico"></img>
        </div>
    </div><!--Los gedes-->
    <div class="card">
        <div class="nome-equipe"><h1>PRO GAMING</h1><h4>WU</h4></div>
        <div class="nome-capitao"><h3><a href="https://api.whatsapp.com/send?phone=6282112908593">BOSS<span class="icon-whats"><i class="fa-brands fa-whatsapp"></i></span></h3></a></div>
        <div class="horario">
            <div class="hor-atual">
                <p id="indonesia" onload="horaIndonesia();"></p>
            </div>
            <img src="icons/indonesia.png"></img>
        </div>
    </div><!--PRO GAMING-->
    <div class="card">
    ...
    <div class="card">
        ...
        <div class="horario">
        <div class="hor-atual">      
                <p id="dalmo" onload="horaDalmo();"></p>
            </div>
            <img src="icons/argentina.ico"></img>
        </div>
    </div><!--VETERANOS DE GUERRA-->
    <div class="card">
        <div class="nome-equipe"><h1 style="font-size:20px">TERRORISTAS DELTA</h1><h4>TRRD</h4></div>
        <div class="nome-capitao"><h3><a href="https://api.whatsapp.com/send?phone=5546999423831">Das_trevas<span class="icon-whats"><i class="fa-brands fa-whatsapp"></i></span></h3></a></div>
        <div class="horario">
            <div class="hor-atual">
                <p id="dastrevas" onload="horaDasTrevas();"></p>
            </div>
            <img src="icons/brasil.ico"></img>
        </div>
    ...
    <div class="card">
        ...
        <div class="horario">
            <div class="hor-atual">
            <div class="hor-atual">
                <p id="devil" onload="horaDevil();"></p>
            </div>
            </div>
            <img src="icons/myanmar.ico"></img>
        </div>
    </div><!--BLACK ORDERS-->
    <div class="card">
    ...
    <div class="card">
        ...
        <div class="horario">
            ...
            <img src="icons/venezuela.ico"></img>
        </div>
