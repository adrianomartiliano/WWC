                ...
                <form action="x1.php" method="POST">
                    ...
                    <div class="campus-form">
                        ...
                        <select name="clan" id="clan">
                            <option value="" selected="selected">SEM CLAN</option>
                            <option value="CAN" >CANGACEIROS - CAN</option>
                            <option value="MUND" >MUNDIALES - MUND</option>
                            <option value="DARK" >DARK</option>
                            <option value="TS" >THREAT SIGNAL - TS</option>
                            <option value="GNR" >GUNS N ROSES - GNR</option>
                            <option value="TEAM" >LION PRIDE - TEAM</option>
                            <option value="WIN" >WINNERS - WIN</option>
                            <option value="WU" >WU GAMING - WU</option>
                            <option value="G_E" >GUERREIROS ESPARTAS - G_E</option>
                        </select>
                    </div>
                    <div class="campus-form">
                    ...
                    <div class="campus-form">
                        <label for="contato">WHATSAPP</label><input type="text" name="contato" id="contato" placeholder="Con código do país" required>
                    </div>
                    
                    
                    <input type="submit" name="submit" value="OK" id="btn-enviar-inscricao">
                </form>
            </div>
        </div>
    </section><!--INSCRICAO-->
